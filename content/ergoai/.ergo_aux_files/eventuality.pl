...
#define FLORA_COMPILATION_ID 16
...
#mode save
#mode nocomment "%"
#define FLORA_FDB_FILENAME  'eventuality.fdb'
#mode restore
...
#mode save
#mode nocomment "%"
#define FLORA_FLD_FILENAME  'eventuality.fld'
#mode restore
...
?-(:(flrutils,util_load_structdb('eventuality.ergo',FLORA_THIS_MODULE_NAME))).
